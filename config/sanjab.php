...
return [
    ...
    'controllers' => [
        ...
        App\Http\Controllers\Admin\Crud\CountryController::class,
        App\Http\Controllers\Admin\Crud\StateController::class,
        App\Http\Controllers\Admin\Crud\CityController::class,
        App\Http\Controllers\Admin\Crud\ClientController::class,
        App\Http\Controllers\Admin\Crud\AddressController::class,
    ],
    ...
    'theme' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        'footer_note' => 'Grupo Excelencias &copy; <script>document.write(new Date().getFullYear())</script>',
        ...
        */
        'footer_links' => [
            ['title' => 'MallHabana.com', 'link' => 'https://www.mallhabana.com/'],
