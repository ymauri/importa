@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => "Importa"])
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                <span class="form-check-sign">
                  <span class="check text-info"></span>
                </span>
                Estoy de acuerdo con la <a href="#" class="text-info">Política de privacidad</a>
              </label>
            </div>
          </div>
