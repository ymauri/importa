<div id="areaProductoList" class="modal fade product-list-modal" tabindex="-1" role="dialog" aria-labelledby="areaProductoList" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                <table class="table table-hover" style="width:100%" id="datatable_products">
                </table>
            </div>
