                        ...
                        <div class="card-body ">
                            ...
                            <div class='row'>
                                ...
                                <div class="col-sm-7">
                                    <div class="custom-control custom-radio  custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="1" id="order-ena" name="order[type]" required="required" @if($order->type == 1) checked @endif>
                                        <label class="custom-control-label" for="order-ena">ENA</label>
                                    </div>
                                    <div class="custom-control custom-radio  custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="2" id="order-importacion" name="order[type]" required="required" @if($order->type == 2) checked @endif>
                            ...
                            <div id="destiny-data" @if($order->type == 1)  style="display:none" @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <select  class="form-control" type="text" placeholder="Busca el nombre de algún destinatario ..."  required="false" aria-required="true" id="select_dest">
                                            <option value="0"></option>
                                        </select>
                                    </div>
                                </div>
