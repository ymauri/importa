              ...
              <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control{{ $errors->has('product[weight]') ? ' is-invalid' : '' }}" name="product[weight]" type="text" placeholder="Peso en kilogramos (Kg)" value="{{ $product->weight }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control{{ $errors->has('product[volumen]') ? ' is-invalid' : '' }}" name="product[volumen]" type="number" placeholder="Volumen en metros cúbicos (m3)" value="{{ $product->volumen }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control{{ $errors->has('product[price]') ? ' is-invalid' : '' }}" name="product[price]" type="number" placeholder="Precio unitario (USD)" value="{{ $product->price }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control{{ $errors->has('product[customs_points]') ? ' is-invalid' : '' }}" name="product[customs_points]" type="number" placeholder="Puntos aduanales" value="{{ $product->customs_points }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input class="form-control{{ $errors->has('product[charter]') ? ' is-invalid' : '' }}" name="product[charter]" type="number" placeholder="Costo del flete marítimo (USD)" value="{{ $product->charter }}" required="true" aria-required="true"/>
